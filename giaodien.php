    ...
    <div id="wrapper">
        <header>
	         <nav class="container">
                ...
                <ul id="main-menu">
                    <li><a href="menu.php"> Black Rouge</a></li>
                    <li><a href="menu.php"> 3ce</a></li>
                    <li><a href="menu.php"> Gucci</a></li>
                    <li><a href="menu.php"> Dior</a></li>
                    <li><a href="menu.php"> Srum</a></li>
                </ul>
                </div>
                ...
                <ul id="main-menu-right2">
                    <li><a href="logindnweb.php">Đăng Nhập</a></li>
                    <li><a href="registerweb.php">Đăng Kí</a></li>
                </ul>
                </div>
             </nav>
        </header>
        <menu>
            <div id="formList">
                <div id="list">
                    <div class="item">
                        <img src="./images/anh1.jpeg"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh13.jpg"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh3.webp"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh4.png"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh5.jpg"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh6.jpg"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh7.jpg"  class="avatar" alt=""> 
                    </div>
                    <div class="item">
                        <img src="./images/anh8.jpg"  class="avatar" alt=""> 
                    </div>
					<div class="item">
                        <img src="./images/anh9.jpg"  class="avatar" alt=""> 
                    </div>
					<div class="item">
                        <img src="./images/anh10.jpg"  class="avatar" alt=""> 
                    </div>
					<div class="item">
                        <img src="./images/anh11.jpg"  class="avatar" alt=""> 
                    </div>
					<div class="item">
                        <img src="./images/anh12.png"  class="avatar" alt=""> 
                    </div>
					<div class="item">
                        <img src="./images/anh14.jpg"  class="avatar" alt=""> 
                    </div>
					<div class="item">
                        <img src="./images/anh15.jpg"  class="avatar" alt=""> 
                    </div>
                </div>
            </div>
            <div class="direction">
        ...
        <footer>
            ...
            <li><a href="tel:036-999-9999">Điện thoại: <span>036-999-9999</span></a></li>
                        <li><a href = "mailto: 6aesnn@duck.com">Email: <span>altth@duck.com</span></a></li>
