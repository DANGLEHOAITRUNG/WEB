...
<?php
		...
		$hoTen= $_POST['name'];
		//1.ket noi
		$kn = mysqli_connect("localhost","root","","dbdangky") or die ("Khong co ket noi");
		//2,3
		//4 xay dung cau lenh truy van
		$sql="select * from tbthongtin where Username='".$username."' and Password='".$password."'";
		...
		if($row= mysqli_fetch_array($result)){
			...
			header('location: logindnweb.php');
		}		
		mysqli_close($kn);
    }
?>
        ...
        <div class="login-card">
            ...
            <div class="login-card-form" >
                ...
                <div class="form-item-other">
                    ...
                    <a href="http://localhost/Web_TLam/DoiMatKhau.php">Forgot password</a>
                </div>
					<button type="submit" name="dn" >Login</button>
				</form>
            </div>
            <div class="login-card-footer">
                Don't have an account ? <a href="registerweb.php">Sign Up</a>
            </div>
