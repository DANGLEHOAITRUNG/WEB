...
<?php
	...
	{//Lay du lieu tu form
		...
		$cauLenh="insert into tbthongtin(Username,Mail,HoTen,Password) values('".$tendn."','".$diaChiMail."','".$hoTen."','".$matKhau."')";
		$cauLenhKt="select * from tbthongtin where Username='".$tendn."'";
